                        ...
                        <div   class="table-responsive">
                          <table class="table">
                            ...
                            <div class="modal-footer">
                              <button type="button" class="btn btn-success" @click="save()" style="margin-right: 10px;" ><i class="material-icons">check</i>Guardar cambios</button>
    ...
    export default {
      ...
      data (){
        ...
        methods:{ 
          save(){ 
             let me=this;
                axios.post('/regCandidatoRequisitos', { 
                'idcandidato':this.datamodal.idcandidato,
